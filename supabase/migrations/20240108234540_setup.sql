...
AS $$
DECLARE
  project_url TEXT := 'https://ibmgjyjgigtofalexogg.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImlibWdqeWpnaWd0b2ZhbGV4b2dnIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NTkxNjY2NywiZXhwIjoyMDYxNDkyNjY3fQ.ZD9XQiOloOzuZt5IrOk4AVfu5VHz8OGJkTcu2aYDNhA'; -- full access needed for http request to storage
